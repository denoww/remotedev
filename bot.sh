...
EOF
    ...
    echo "claude - Claude Code no projeto"
    echo "git - Comandos git"
    echo "rails - Rails runner/console"
    echo "rake - Rake task"
    echo "log - Ultimas linhas do log"
    echo "ping - Verifica se desktop esta online"
    echo "id - Mostra seu chat_id"
